...
public class MoneyConverter extends JFrame {
    ...
    final double USDtoPHP = 57.90;
    final double PHPtoUSD = 1 / USDtoPHP;
    
    final double USDtoEuro = 0.95;
    final double EurotoUSD = 1 / USDtoEuro;
    
    final double USDtoJapYen = 149.68;
    final double JapYentoUSD = 1 / USDtoJapYen;
    
    final double USDtoGBP = 0.79;
    final double GBPtoUSD = 1 / USDtoGBP; //poundSterling from UK
    
    final double USDtoAUD = 1.57;
    final double AUDtoUSD = 1 / USDtoAUD;
    
    final double USDtoCAND = 1.42;
